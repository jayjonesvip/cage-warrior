(async () => {
  ...
  const ICON_ASSET_VERSION = '2.5.219';
  ...
  function normalizeOpponentArchetype(o){
    if(!o)return;if(o.rookieShowcase){o.archetype='striker';o.tendency='striker';o.tag='ROOKIE TEST';o.scout=ROOKIE_SHOWCASE.scout;return}const id=normalizeMajorArchetype(o.archetype)||normalizeMajorArchetype(o.tendency)||'striker',arch=opponentArchetypes.find(a=>a.id===id)||opponentArchetypes[0];o.archetype=arch.id;o.tendency=arch.id;o.tag=arch.tag;o.scout=arch.scout;
  }
