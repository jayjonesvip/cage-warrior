(function(root){
  ...
  root.CAGE_FIGHT_FOCUS_CONTACTS=[
      {id:'mom',name:'MOM',avatar:'assets/contact-mom.jpg?v=2.5.120',ignoreDelta:-4,ignoreText:'You leave Mom’s message unread, but keep wondering why she texted tonight.',messages:[
      ...
      {id:'wife',name:'WIFE',avatar:'assets/contact-wife.jpg?v=2.5.120',ignoreDelta:-5,ignoreText:'You leave your wife’s message unread, and the notification follows you toward the cage.',messages:[
      ...
      {id:'brother-tommy',name:'BROTHER TOMMY',avatar:'assets/contact-brother-tommy.png?v=2.5.120',ignoreDelta:-3,ignoreText:'You leave Tommy’s message unread. With him, that could mean anything.',messages:[
      ...
      {id:'agent-carl',name:'AGENT CARL',avatar:'assets/contact-agent-carl.png?v=2.5.120',ignoreDelta:-2,ignoreText:'You leave Carl on unread, but wonder what deal—or problem—he is sitting on.',messages:[
      ...
      {id:'grandma',name:'GRANDMA',avatar:'assets/contact-grandma.jpg?v=2.5.120',ignoreDelta:-2,ignoreText:'You leave Grandma on unread. She will tell Grandpa you are too busy for family.',messages:[
