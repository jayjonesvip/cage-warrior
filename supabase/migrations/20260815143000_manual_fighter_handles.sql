-- Allow players to reserve a custom single-word Cage Feed handle while keeping
-- generated CapitalCase identities and legacy lowercase handles valid.
...
'Permanently reserves the first available generated identity or exact manual single-word handle for the authenticated fighter.';
