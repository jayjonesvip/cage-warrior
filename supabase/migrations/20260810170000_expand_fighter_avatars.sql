-- Expand permanent player portraits from 20 to 40 choices.
...
check (fighter_avatar is null or fighter_avatar ~ '^fighter-(0[1-9]|[123][0-9]|40)$');
...
is 'Public ID of the fighter portrait selected during career setup (fighter-01 through fighter-40).';
