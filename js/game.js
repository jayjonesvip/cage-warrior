(async () => {
  ...
  const ICON_ASSET_VERSION = '2.7.164';
  ...
  function finishFightSimulation(){
    ...
    renderResultBonuses(lootNotes);renderDailyHeatResult({won:win,lowerLevelWin,rankRepeatExhausted:win&&o.min<playerLevelBefore&&winsToday>=2&&LOGIC.higherRankedOpponent(ranks),forfeited:!!fight.forfeited,dailyStreakBefore,dailyBonusAwarded});
