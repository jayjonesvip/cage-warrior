...
const CORE_ASSETS=[
  ...
  './js/strings.js?v=2.5.179',
  './js/analytics.js?v=2.5.179',
  './js/supabase-client.js?v=2.5.179',
  './js/cage-social.js?v=2.5.179',
  './js/landing.js?v=2.5.179',
  './js/fight-focus.js?v=2.5.179',
  './js/fight-plan.js?v=2.5.179',
  './js/underground-buzz.js?v=2.5.179',
  './js/definitions.js?v=2.5.179',
  './js/game.js?v=2.5.179',
  './js/pwa.js?v=2.5.179',
  './manifest.webmanifest',
  './app-version.json',
  './assets/cage-grind-logo.png',
  './assets/silhouettes/fighter-silhouette-1.png',
  './assets/focus-locker-room.jpg?v=2.5.179',
  './assets/contact-mom.jpg?v=2.5.179',
  './assets/contact-wife.jpg?v=2.5.179',
  './assets/contact-brother-tommy.png?v=2.5.179',
  './assets/contact-agent-carl.png?v=2.5.179',
  './assets/contact-grandma.jpg?v=2.5.179',
  ...
  './assets/app-icon-512.png?v=2.5.179',
  ...
  './assets/icons/rideshare-driver.jpg?v=2.5.179',
  './assets/icons/mma-shorts.jpg?v=2.5.179',
  './assets/icons/energy-drink.jpg?v=2.5.179',
  './assets/icons/fight-fuel-protein.png?v=2.5.179',
  './assets/icons/fight-fuel-protein-qr.png?v=2.5.179',
  './assets/icons/bobs-auto.png?v=2.5.179',
  './assets/icons/garys-bar-grill.png?v=2.5.179',
  './assets/icons/volt.png?v=2.5.179',
  './assets/icons/ironhide.png?v=2.5.179',
  './assets/icons/apex-wireless.png?v=2.5.179',
  './assets/icons/northline-auto.png?v=2.5.179',
  './assets/icons/titan-global.png?v=2.5.179',
  './assets/icons/title-world.png?v=2.5.179',
  './assets/icons/round-intro-1.png?v=2.5.179',
  './assets/icons/round-intro-2.png?v=2.5.179',
  './assets/icons/round-intro-3.png?v=2.5.179'
