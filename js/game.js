(async () => {
  ...
  const ICON_ASSET_VERSION = '2.7.161';
  ...
  function publishSponsorHighlight(moment){
    const sponsor=state.activeEndorsement?.id,pool=STRINGS.sponsorHighlights?.[sponsor];if(!moment||!pool||!state.socialAccountCreated)return;
