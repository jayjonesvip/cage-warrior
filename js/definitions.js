...
const gearItems = [
  ...
  {id:'fight-fuel-protein',category:'Lifestyle',name:'ALLMAX ISOFLEX',icon:'🥤',rarity:'COMMON',minLevel:2,desc:'Protein recovery between fights. +0.03 Health every 15 seconds.',healthRegen:.03,sponsored:true,brand:'ALLMAX ISOFLEX',sponsorDescription:'Chocolate whey isolate with 27g protein, 0g sugar and 75 servings. Gluten free, soy free and low lactose.',sponsorDisclosure:'AFFILIATE QR · Cage Grind may earn from qualifying purchases.',qrAsset:'assets/icons/fight-fuel-protein-qr.png?v=2.5.223'},
...
const recoveryDefs = [
  {id:'rest',icon:'🔋',title:'Rest',text:'Rest until your Energy battery is full. Each missing segment takes three seconds.',energy:100,health:0,feeBase:0,feePerLevel:0,meterSeconds:3,freeRest:true},
  {id:'surgecore-energy-drink',icon:'⚡',title:'Chug Energy Drink',text:'Crack open a Surge Core for one quick Energy battery segment.',energy:25,health:0,flatFee:25,meterSeconds:2},
