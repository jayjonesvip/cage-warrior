...
const APP_VERSION='2.4.0-desktop.1';
...
const CORE_ASSETS=[
  './',
  './index.html',
  './styles.css?v=2.4.0-desktop.1',
  './game-logic.js?v=2.4.0-desktop.1',
  './strings.js?v=2.4.0-desktop.1',
  './analytics.js?v=2.4.0-desktop.1',
  './supabase-client.js?v=2.4.0-desktop.1',
  './cage-social.js?v=2.4.0-desktop.1',
  './game.js?v=2.4.0-desktop.1',
  './pwa.js?v=2.4.0-desktop.1',
