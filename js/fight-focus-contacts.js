(function(root){
  ...
  root.CAGE_FIGHT_FOCUS_CONTACTS=[
      {id:'mom',name:'MOM',avatar:'assets/contact-mom.jpg?v=2.7.27',ignoreDelta:-4,ignoreText:'You leave Mom’s message unread, but keep wondering why she texted tonight.',messages:[
      ...
      {id:'wife',name:'WIFE',avatar:'assets/contact-wife.jpg?v=2.7.27',ignoreDelta:-5,ignoreText:'You leave your wife’s message unread, and the notification follows you toward the cage.',messages:[
        ...
        {id:'wife-bill',text:'The house situation is getting worse. I need you focused, but I also need you here.',delta:-12},
      ...
      {id:'brother-tommy',name:'BROTHER TOMMY',avatar:'assets/contact-brother-tommy.png?v=2.7.27',ignoreDelta:-3,ignoreText:'You leave Tommy’s message unread. With him, that could mean anything.',messages:[
        {id:'tommy-front-row',text:'Good luck. I’m in the front row. I’ll be the loud one.',delta:10},
        {id:'tommy-payback',text:'I finally handled that problem I caused. After the fight, I’ll explain everything.',delta:8},
        ...
        {id:'tommy-urgent',text:'I got myself into trouble again. It’s urgent. I’ll explain later.',delta:-10},
        ...
        {id:'tommy-bet',text:'I told everybody you cannot lose tonight. You really need to win.',delta:-16}
      ]},
      {id:'agent-carl',name:'AGENT CARL',avatar:'assets/contact-agent-carl.png?v=2.7.27',ignoreDelta:-2,ignoreText:'You leave Carl on unread, but wonder what deal—or problem—he is sitting on.',messages:[
        {id:'carl-sponsor',text:'Big sponsor in the front row. Put on a show and I can make the phone ring tomorrow.',delta:9},
        {id:'carl-opportunity',text:'I got the matchmaker watching closely. Win tonight and the next opportunity gets interesting.',delta:7},
        {id:'carl-agreement',text:'Small paperwork issue: your opponent changed one detail in the agreement. We’ll discuss it later.',delta:-12},
        {id:'carl-bad-deal',text:'I may have promised them an immediate rematch if you lose. Do me a favor and don’t lose.',delta:-9}
      ]},
      {id:'grandma',name:'GRANDMA',avatar:'assets/contact-grandma.jpg?v=2.7.27',ignoreDelta:-2,ignoreText:'You leave Grandma on unread. She will tell Grandpa you are too busy for family.',messages:[
