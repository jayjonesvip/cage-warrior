...
const CORE_ASSETS=[
  ...
  './index.html',
  './styles.css?v=2.5.74',
  './game-logic.js?v=2.5.74',
  './strings.js?v=2.5.74',
  './analytics.js?v=2.5.74',
  './supabase-client.js?v=2.5.74',
  './cage-social.js?v=2.5.74',
  './game.js?v=2.5.74',
  './pwa.js?v=2.5.74',
  './manifest.webmanifest',
  './app-version.json',
  './assets/cage-grind-logo.png',
  './assets/focus-locker-room.jpg?v=2.5.74',
  './assets/contact-mom.jpg?v=2.5.74',
  './assets/contact-wife.jpg?v=2.5.74',
  './assets/contact-brother-tommy.png?v=2.5.74',
  './assets/contact-agent-carl.png?v=2.5.74',
  './assets/cage-grind-ceo.jpg?v=2.5.74',
  './assets/cage-dice.jpg?v=2.5.74',
  ...
  './assets/icons/title-world.png?v=2.5.74',
  './assets/icons/round-intro-1.png?v=2.5.74',
  './assets/icons/round-intro-2.png?v=2.5.74',
  './assets/icons/round-intro-3.png?v=2.5.74'
