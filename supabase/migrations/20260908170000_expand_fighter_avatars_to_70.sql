-- Add portraits 66-70 without changing existing identities or career rules.
...
check (fighter_avatar is null or fighter_avatar ~ '^fighter-(0[1-9]|[1-6][0-9]|70)$');
...
check (fighter_avatar ~ '^fighter-(0[1-9]|[1-6][0-9]|70)$');
...
begin
  ...
  if p_fighter_avatar is null or p_fighter_avatar !~ '^fighter-(0[1-9]|[1-6][0-9]|70)$' then
...
'Public ID of the fighter portrait selected during career setup (fighter-01 through fighter-70).';
commit;
