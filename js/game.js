(async () => {
  ...
  const ICON_ASSET_VERSION = '2.7.22';
  ...
  function showResultStage(stage='outcome'){
    ...
    if(rewards)requestAnimationFrame(()=>$('#continueBtn').focus());
  }
