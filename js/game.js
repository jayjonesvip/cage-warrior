(async () => {
  ...
  const ICON_ASSET_VERSION = '2.7.17';
  ...
  function renderSocial(){
    ...
    $('#feedCycleStatus').textContent=!accountReady?'ACCOUNT NOT CREATED':sharedReady?`${sharedSocialInteractionsRemaining}/5 POSTS LEFT`:sharedSocialStatus==='loading'?'CONNECTING':'LOCAL FEED';$('#feedFollowersCount').textContent=fmt(state.fans);$('#feedFollowingCount').textContent=fmt(feedFollowingTotal());
