(async () => {
  ...
  const ICON_ASSET_VERSION = '2.7.73';
  ...
  const defaultState = {
    ...
    energy:100,maxEnergy:100,health:100,maxHealth:100,aura:0,
  ...
  function openSocialCycle(type,data={}){
    ...
    if(type==='fight'){
      ...
      if(data.win){const key=data.winStreak>=2?'fightStreak':'fightWin',entries=key==='fightStreak'?cycles.fightStreakHeadline:cycles[key];addHeadline(key,entries,values)}
  ...
  function finishFightSimulation(){
    ...
    pendingPostFightText=selectPostFightText({won:win,forfeited:!!fight.forfeited,titleWon,titleFight:!!o.globalChampionship,winStreak:state.winStreak,opponent:o.name});
    ...
    openSocialCycle('fight',{win,opponent:o.name,method:fight.method,winStreak:state.winStreak,title:''});
