...
opponentNames: {
  ...
  social: {
    profiles: {
      media: {author:'CageReporter',handle:'@CageReporter',tone:'media',avatar:'assets/cage-reporter.jpg?v=2.7.205',verified:true,bio:'Cage Grind’s official fight desk. Publishes contract signings and official fight results.'},
      ceo: {author:'Cage Grind CEO',handle:'@CageGrindCEO',tone:'ceo',avatar:'assets/cage-grind-ceo.jpg?v=2.7.205',verified:true,bio:'Founder and CEO of Cage Grind. Builds the cards, signs the title fights, and decides which performances deserve the biggest stage.'},
...
interactions: {
  ...
  postFightTexts: {
    firstWin: ["Your first win! I saw them raise your hand, @{name}.", "I’m proud of you. Take a breath, then show them what comes next."],
    chance: .32,
    contacts: [
      {id:'unknown-number',name:'Unknown Number',relationship:'NOT IN CONTACTS',avatar:'assets/contact-unknown.svg',messages:[
        ['Congrats on the fight. We’ve been trying to reach you about your home warranty.'],
        ['So you can go three rounds with a stranger but couldn’t communicate with me? — your ex'],
        ['Your table for six is ready. Please stop telling the hostess you’re a world champion.'],
        ['I caught your mouthguard. We have the same bite. What do you think that means?'],
        ['Wrong number, sorry. Unless you’re the guy who owes me $40 and a folding chair.'],
        ['Is this the guy from the fight? My printer is doing that same noise you made in round two.'],
        ['Hey, it’s your ex again. The announcer said you have great commitment. Interesting.'],
        ['I named my sourdough starter after you. It also needs three days to recover.'],
        ['Your driver is outside. I’m in the silver sedan. Please leave the cage at home.'],
        ['I was the guy yelling “KICK HIM” during the fight. Just making sure you heard my coaching.']
      ]},
  ...
  ticker: [
    'Roster wins earn two Attribute Points above your tier, one within it, and zero below. Circuit rewards stay level-based. Assign points on the Fight page.',
