...
const APP_VERSION='2.4.0-desktop.2';
...
const CORE_ASSETS=[
  './',
  './index.html',
  './styles.css?v=2.4.0-desktop.2',
  './game-logic.js?v=2.4.0-desktop.2',
  './strings.js?v=2.4.0-desktop.2',
  './analytics.js?v=2.4.0-desktop.2',
  './supabase-client.js?v=2.4.0-desktop.2',
  './cage-social.js?v=2.4.0-desktop.2',
  './game.js?v=2.4.0-desktop.2',
  './pwa.js?v=2.4.0-desktop.2',
