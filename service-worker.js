...
const CORE_ASSETS=[
  ...
  './index.html',
  './styles.css?v=2.5.69',
  './game-logic.js?v=2.5.69',
  './strings.js?v=2.5.69',
  './analytics.js?v=2.5.69',
  './supabase-client.js?v=2.5.69',
  './cage-social.js?v=2.5.69',
  './game.js?v=2.5.69',
  './pwa.js?v=2.5.69',
  './manifest.webmanifest',
  './app-version.json',
  './assets/cage-grind-logo.png',
  './assets/focus-locker-room.jpg?v=2.5.69',
  './assets/contact-mom.jpg?v=2.5.69',
  './assets/contact-wife.jpg?v=2.5.69',
  './assets/contact-brother-tommy.png?v=2.5.69',
  './assets/contact-agent-carl.png?v=2.5.69',
  './assets/cage-grind-ceo.jpg?v=2.5.69',
  './assets/cage-dice.jpg?v=2.5.69',
  ...
  './assets/icons/round-intro-1.png?v=2.5.69',
  './assets/icons/round-intro-2.png?v=2.5.69',
  './assets/icons/round-intro-3.png?v=2.5.69'
