-- Add Boston, Atlanta, San Francisco, and Denver as permanent fighter hometowns.

alter table public.cage_profiles
drop constraint if exists cage_profiles_city;

alter table public.cage_profiles
add constraint cage_profiles_city check (
  city in (
...
comment on constraint cage_profiles_city on public.cage_profiles is
'Permanent Cage Grind hometown selected during fighter creation.';
