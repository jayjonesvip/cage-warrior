(async () => {
  ...
  const ICON_ASSET_VERSION = '2.7.97';
  ...
  let installOfferDismissed = (()=>{try{return sessionStorage.getItem(INSTALL_OFFER_DISMISS_KEY)==='1'}catch{return false}})();
