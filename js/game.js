(async () => {
  ...
  $('#detailsToggle').addEventListener('click',()=>{const details=$('#resultDetails'),open=!details.classList.contains('open');details.classList.toggle('open',open);$('#detailsToggle').textContent=open?'HIDE SCORECARD':'VIEW SCORECARD'});$('#resultScorecardToggle').addEventListener('click',()=>toggleResultSection('resultScorecardSection'));$('#resultTapeToggle').addEventListener('click',()=>toggleResultSection('resultTapeSection'));$('#shareWinBtn').addEventListener('click',shareFightWin);
