(async () => {
  ...
  const ICON_ASSET_VERSION = '2.5.223';
  ...
  const defaultState = {
    version:23,name:'ROOKIE',nameLocked:false,rookieShowcasePending:false,cash:0,careerEarnings:0,fans:0,level:1,xp:0,wins:0,losses:0,winStreak:0,bestStreak:0,
