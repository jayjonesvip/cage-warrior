(async () => {
  ...
  const ICON_ASSET_VERSION = '2.7.168';
  ...
  function renderRecoveryClocks(){
    $('#hudHealthLabel').textContent=`HEALTH · ${LOGIC.healthTierName(state.health,state.maxHealth)}`;
