...
const CORE_ASSETS=[
  ...
  './index.html',
  './styles.css?v=2.5.37',
  './game-logic.js?v=2.5.37',
  './strings.js?v=2.5.37',
  './analytics.js?v=2.5.37',
  './supabase-client.js?v=2.5.37',
  './cage-social.js?v=2.5.37',
  './game.js?v=2.5.37',
  './pwa.js?v=2.5.37',
  './manifest.webmanifest',
  './app-version.json',
  './assets/cage-grind-logo.png',
  './assets/focus-locker-room.jpg?v=2.5.37',
  './assets/contact-mom.jpg?v=2.5.37',
  './assets/contact-wife.jpg?v=2.5.37',
