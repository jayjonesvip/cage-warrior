(() => {
  ...
  const ICON_ASSET_VERSION = '2.5.143';
  ...
  function toast(msg,color='white',iconName='',iconFallback=''){
    ...
    clearTimeout(t._to);t._to=setTimeout(()=>t.classList.remove('show-toast'),1700);
  }
