(function(root,factory){
  ...
  const defaults={
    ...
    cashAndExperienceRewards:{lossPurseMultiplier:.08,victoryBaseExperiencePoints:26,victoryExperiencePointsPerOpponentLevel:9,earlyCareerExperienceBonusMaximum:20,earlyCareerExperienceBonusReductionPerOpponentLevel:5,lossExperienceMultiplier:.375,rankedFightExperienceMultiplier:1.2,championshipFightExperienceMultiplier:1.3,upsetVictoryExperienceMultiplier:1.25,lowerLevelOpponentExperienceMultiplier:0,worldTitleVictoryExperienceBonus:25,sameDayRunbackExperienceMultiplier:.5,winHypeGain:8,exhaustedOpponentHypeChange:-7,maximumWinStreakPurseBonus:.25,winStreakPurseBonusPerAdditionalWin:.05,upsetVictoryPurseBonus:.25,rivalryPurseBonus:.15,hypePurseDivisor:130}
  };
