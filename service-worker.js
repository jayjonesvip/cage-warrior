...
const CORE_ASSETS=[
  ...
  './index.html',
  './styles.css?v=2.5.71',
  './game-logic.js?v=2.5.71',
  './strings.js?v=2.5.71',
  './analytics.js?v=2.5.71',
  './supabase-client.js?v=2.5.71',
  './cage-social.js?v=2.5.71',
  './game.js?v=2.5.71',
  './pwa.js?v=2.5.71',
  './manifest.webmanifest',
  './app-version.json',
  './assets/cage-grind-logo.png',
  './assets/focus-locker-room.jpg?v=2.5.71',
  './assets/contact-mom.jpg?v=2.5.71',
  './assets/contact-wife.jpg?v=2.5.71',
  './assets/contact-brother-tommy.png?v=2.5.71',
  './assets/contact-agent-carl.png?v=2.5.71',
  './assets/cage-grind-ceo.jpg?v=2.5.71',
  './assets/cage-dice.jpg?v=2.5.71',
  ...
  './assets/icons/round-intro-1.png?v=2.5.71',
  './assets/icons/round-intro-2.png?v=2.5.71',
  './assets/icons/round-intro-3.png?v=2.5.71'
